...
export const DEFAULT_TEACHER_SETTINGS: TeacherStudioSettings = {
  ...
  paymentInfo: {
    ...
    accountHolder: 'André Martins (A Voz da Guitarra)',
    acceptsCash: true,
    cashInstructions:
...
export const registerNewStudent = (
  ...
  const newSchedule: ScheduleItem = {
    ...
    teacherName: teacherSettings.teacherName || 'Prof. André Martins',
  ...
  if (isAuthorizedTeacherEmail(normEmail)) {
    ...
    if (!teacherAcc) {
      teacherAcc = {
        ...
        email: PRIMARY_TEACHER_EMAIL,
        name: googleUser.name || 'Prof. André Martins (A Voz da Guitarra)',
        role: 'professor',
        avatarUrl:
