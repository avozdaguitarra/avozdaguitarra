          ...
          <div>
            ...
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 space-y-2 mb-4">
              ...
              <div className="flex items-center justify-between text-xs text-slate-500">
                ...
                <span className="font-semibold text-slate-700">{teacherSettings.paymentInfo?.accountHolder || 'Prof. André Martins'}</span>
              </div>
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 space-y-2 mb-4">
              ...
              <div className="flex items-center justify-between text-xs text-slate-500">
                <span>Titular:</span>
                <span className="font-semibold text-slate-700">{teacherSettings.paymentInfo?.accountHolder || 'André Martins'}</span>
              </div>
