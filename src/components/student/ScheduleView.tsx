...
import { Calendar, Clock, MapPin, Video, UserCheck, Sparkles, Download, CheckCircle2 } from 'lucide-react';
...
export const ScheduleView: React.FC<ScheduleViewProps> = ({ student, schedule }) => {
    ...
    <div id="student-schedule-view" className="space-y-6">
      ...
      {schedule ? (
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row md:flex-col gap-3 min-w-[200px]">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-white/10 hover:bg-white/15 text-white font-semibold rounded-xl border border-white/20 flex items-center justify-center gap-2 text-xs transition-colors"
              >
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-amber-900 text-sm">
          Ainda não existe um horário semanal configurado para este aluno. O professor irá agendar em breve.
        </div>
      )}
